  ...
  return (
    <Dialog open={open}
      ...
      <DialogContent>
          ...
          <Typography gutterBottom variant="h5">Traveling Salesperson Problem</Typography>
          <Typography gutterBottom variant="body1">
          The traveling salesperson problem (TSP) asks the question, "Given a list of cities and the distances between each pair of cities, what is the shortest possible route that visits each city and returns to the origin city?".
          </Typography>
          <Typography gutterBottom variant="body1">
